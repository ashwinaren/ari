...
export default class LmsSales extends LightningElement {
    ...
    handleSubscribe(){
        if (this.subscription){
            ...
            console.log(' Inside Sales message -- '+JSON.stringify(this.receivedMessage)); 
            console.log(' 1Inside Sales message -- '+this.receivedMessage);
