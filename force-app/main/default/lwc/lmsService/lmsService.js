...
export default class LmsService extends LightningElement {
    ...
    handleSubscribe(){
        if (this.subscription){
            ...
            subscribeMC(this.messageContext, (subscription, message) => {
                ...
                console.log(' Inside Service message -- '+JSON.stringify(this.receivedMessage)); 
                console.log(' 1Inside Service message -- '+this.receivedMessage);                                        
            });
