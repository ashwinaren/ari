({
    fetchPicklistValues: function(component,objDetails,controllerField, dependentField,mapAttrName) {
        ...
        var action = component.get("c.callDependentPicklist");
        ...
        action.setCallback(this, function(response) {
            if (response.getState() == "SUCCESS") {
                ...
                alert('Inside success fetchPicklistValues --> '+JSON.stringify(StoreResponse));
                ...
                alert('Something went wrong in fetchPicklistValues --> '+ response.getState());
    ...
    fetchDepValues: function(component, ListOfDependentFields,lstAttrName) {
        ...
        for (var i = 0; i < ListOfDependentFields.length; i++) {
            alert('Inside fetchDepValues --> '+ListOfDependentFields[i]);
